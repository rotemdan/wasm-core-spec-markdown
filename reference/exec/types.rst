...
Execution has to check and compare :ref:`types <syntax-type>` in a few places, such as :ref:`executing <exec-call_indirect>` :math:`\mathsf{call\_indirect}` or :ref:`instantiating <exec-instantiation>` :ref:`modules <syntax-module>`.
...
.. math::
   \begin{array}[t]{@{}lcl@{}l@{}}
   {{\insttype}}_{{\moduleinst}}(t) & = & {t}{{}[ {\assignsubst}\, {\moduleinst}{.}\MITYPES ]} \\
   \end{array}
